...
function shuffleWithConstraint<T>(
  arr: T[],
  isHigh: (t: T) => boolean,
  maxAdj = 2,
  rng: () => number,
...
export function generateDefenseInstances(
  template: DefenseTemplateSlot[],
  opts: GenerateDefenseOptions,
  ...
  return ordered.map((slot) => {
    ...
    return {
      id: makeDefenseId(),
      archetype: slot.archetype as any,
      tier,
