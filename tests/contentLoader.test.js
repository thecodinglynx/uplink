...
beforeAll(() => {
    ...
    // Valid mission
    fs.writeFileSync(path.join(missionsDir, 'm1.json'), JSON.stringify({
        id: 'm1',
        title: 'Test Mission',
        type: 'standard',
        factions: ['fac1'],
    ...
    fs.writeFileSync(path.join(missionsDir, 'm_invalid.json'), JSON.stringify({
        id: 'm_invalid',
        title: 'Bad Mission',
        type: 'standard',
        factions: [],
    ...
    fs.writeFileSync(path.join(narrativeDir, 'n1.json'), JSON.stringify({ id: 'n1', act: 1, version: 1 }));
    // Economy
    fs.writeFileSync(path.join(contentDir, 'economy.json'), JSON.stringify({
